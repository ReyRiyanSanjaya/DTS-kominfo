...
<div class="row no-gutters">
	<div class="col-md-2 bg-dark pr-3" style="background: linear-gradient(to bottom, #ffffff 0%, #00ffff 88%);height: 780px;">
		<ul class="nav flex-column ml-0 mb-0 pr-0 pl-0 pt-0 pb-0 mt-0"><br>
		  ...
		  <a class="navlink">
			  ...
			  <img src="../assets/img/profile.png" class="rounded-circle" alt="profile" style="height: 150px; width: 150px;">
      		  ...
      		  <a class="nav-link" href="user.php"><i class="fas fa-archway 2x"></i> Daftar semua Users<hr class="bg-secondary"></a>
      		  <a class="nav-link" href="editUsers.php"><i class="fab fa-bandcamp 5x"></i> Edit User<hr class="bg-secondary"></a>
		</ul>
	</div>