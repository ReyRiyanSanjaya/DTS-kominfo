...
<div class="row no-gutters">
	<div class="col-md-2 bg-dark pr-3" style="background: linear-gradient(to bottom, #ffffff 0%, #00ffff 88%);">
		<ul class="nav flex-column ml-0 mb-0 pr-0 pl-0 pt-0 pb-0 mt-0"><br>
		  ...
		  <a class="nav-link" href="index.php">Dashbord<hr class="bg-secondary"></a>
		  <a class="nav-link" href="daftarKetua.php">Daftar Ketua<hr class="bg-secondary"></a>
		  <a class="nav-link" href="daftarSekret.php">Daftar Sektretaris<hr class="bg-secondary"></a>
		  <a class="nav-link" href="daftarAnggota.php">Daftar Anggota<hr class="bg-secondary"></a>
		  <a class="nav-link" href="caUsers.php">Daftar Calon User<hr class="bg-secondary"></a>
		  <a class="nav-link" href="users.php">Daftar semua Users<hr class="bg-secondary"></a>
		</ul>
	</div>
